...
public class UserDataDAO {
    ...
    public ArrayList<UserDataDTO> search(UserDataDTO ud) throws SQLException{
        ...
        try{
            ...
            int ac=1;
            if(nameflag){
                st.setString(ac, "%"+ud.getName()+"%");
                ac++;
            }
            if(birthdayflag){
                st.setString(ac, "%"+ new SimpleDateFormat("yyyy").format(ud.getBirthday())+"%");
                ac++;
            }
            if(typeflag){
                st.setInt(ac, ud.getType());
            }
            
            ArrayList<UserDataDTO>data=new ArrayList<UserDataDTO>();
