...
public class DBsousa12 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           int data1=Integer.parseInt(request.getParameter("age"));
             try {
                  ...
                  db_st=db_co.prepareStatement("select * from profiles where name=? and age=? and birthday=?");
                  db_st.setString(1,request.getParameter("name"));
                  db_st.setInt(2,data1);
                  db_st.setString(3,request.getParameter("day"));
