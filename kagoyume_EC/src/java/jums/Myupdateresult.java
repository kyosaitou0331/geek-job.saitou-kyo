...
public class Myupdateresult extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            UserDataDTO data=(UserDataDTO)session.getAttribute("userdate");
            ...
            ud.UDtoDTOMapping(userdata);
            
            UserDataDAO.getInstance().update(userdata,data);
            
            UserDataDTO userdate =UserDataDAO.getInstance().updateinsert(data);
